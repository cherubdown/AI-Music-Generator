...
**Version:** 1.0  
**Date:** February 2026  
**Goal:** Build a complete Python application that trains a neural network on the **JSB-Chorales** dataset (Bach’s 4-part chorales) and generates new music in Bach’s style. Output: new MIDI files and optionally rendered scores.
